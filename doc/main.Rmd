...
author: "Ruxue Peng, Rapha?f«l Ruscassie, Yifei Tang, Connie Zhou, Hongyi Zhu"
date: "Mar 22, 2017"
output: pdf_document: 
...
packages.used=c("gbm", "glmnet", "plyr", "RSNNS","e1071", "caret")
...
![image](../figs/feature_trimmer.png)

Passive Aggressive Classifer: 

![image](../figs/python1.png)

![image](../figs/python2.png)
...
![image](../figs/regression_models.png)
...
**bold** Model 1: Multilayer perceptron.
mlp_tune returns a matrix of training and testing accuracy, size, or number of hidden layer(s), and maxit, or maximum number of iterations to learn. Here, one can view the MLP result and rank them by testing accuracy to select the best parameters.
```{r mlp_tune}
...
Now we introduce another classifier: 
**bold** support vector machine.
